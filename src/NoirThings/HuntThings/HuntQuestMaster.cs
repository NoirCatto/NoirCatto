    ...
    public class HuntQuestMaster
    {
        ...
        public void LoadOrCreateQuests()
        {
            ...
            if (!newQuests.Any())
            {
                ...
                var karmaCap = StorySession.saveState.deathPersistentSaveData.karmaCap;
        ...
        public void SaveQuestProgress()
        {
            ...
            SaveThings.CustomSaveData.SaveStorySpecific(HUNTQUEST_DATA, questsToSave, StorySession);
        }
