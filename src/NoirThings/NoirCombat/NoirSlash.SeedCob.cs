...
public partial class NoirCatto
{
    ...
    *******************************************************************************************************/
    internal static void SeedCobILUpdate(ILContext il)
    {
        ...
        {
            LogSource.LogError("ILHook failed - SeedCob Update");
    ...
    *******************************************************************************************************/
    internal static void WeaponILUpdate(ILContext il)
    {
        ...
        {
            LogSource.LogError("ILHook failed - Weapon Update");
            LogSource.LogError(ex);
        }
    }
    ...
    *******************************************************************************************************/
    internal static void SharedPhysicsILTraceProjectileAgainstBodyChunks(ILContext il)
    {
        ...
        {
            LogSource.LogError("ILHook failed - SharedPhysics.TraceProjectileAgainstBodyChunks");
            LogSource.LogError(ex);
        }
    }
}