    ...
    public partial class CatSlash : Weapon
    {
        ...
        public override bool HitSomething(SharedPhysics.CollisionResult result, bool eu)
        {
            ...
            if (result.obj is Creature crit)
            {
                ...
                var baseStunValue = ModOptions.NoirBuffSlash.Value ? 20f : 10f;
                var baseDamageValue = ModOptions.NoirBuffSlash.Value ? 0.2f : 0.1f;
                ...
                //NOTE: Add custom handling for Poacher here later
