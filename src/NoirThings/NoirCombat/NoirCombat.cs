...
public partial class NoirCatto
{
    ...
    {
        if (self.SlugCatClass != Const.NoirName) return orig(self, favorspears);
    ...
    public static void PlayerOnGrabUpdate(On.Player.orig_GrabUpdate orig, Player self, bool eu)
    {
        orig(self, eu);
        if (self.SlugCatClass != Const.NoirName) return;
        NoirMaul(self, eu);
    }
