...
public partial class NoirCatto
{
    ...
    *******************************************************************************************************/
    public static void PlayerILUpdateAnimation(ILContext il)
    {
        try
        {
        ...
        {
            LogSource.LogError($"ILHook failed for CrawlTurn due to {ex}");
        }
    }
    ...
    private static bool CustomCrawlTurn(Player self)
    {
        ...
        if (!self.TryGetNoirData(out var noirData)) return false;
